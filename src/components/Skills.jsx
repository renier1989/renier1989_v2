...
function Skills({language}) {
  return (
    <section id="skills" className="flex flex-col py-20 rounded-md">
      <div className="bg-second rounded-md py-20">
        <div className=" z-0  md:order-2  justify-center  flexCenter  ">
              ...
              >
                <img src={logo2g} alt="profile" className="z-0 md:max-w-[450px] md:relative -left-[790px] top-[720px] transition duration-500 " />
              </motion.div>
          </div>
